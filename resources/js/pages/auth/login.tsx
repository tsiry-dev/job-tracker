            ...
            <form className="flex flex-col gap-6" onSubmit={submit}>
                <div className="grid gap-6">
                    <div className="grid gap-2">
                        <Label htmlFor="email" className='text-white'>Addresse email</Label>
                        <Input
                            id="email"
                            type="email"
                            required
                    ...
                    <Button type="submit" className="mt-4 w-full bg-black text-white" tabIndex={4} disabled={processing}>
